...
for o in range(0,17):
    for p in range(0,20):
            product = matrix[o][p]*matrix[o+1][p]*matrix[o+2][p]*matrix[o+3][p]
            print(product)
            print("o=",o," och p=",p)
            if product > största:
                största = product

#diagonala åt höger element
for q in range(0,17):
    for r in range(0,17):
...
#diagonala åt vänster element
for s in range(3,20):
    for t in range(0,17):
            product = matrix[s][t]*matrix[s-1][t+1]*matrix[s-2][t+2]*matrix[s-3][t+3]
            print(product)
            print("s=",s," och t=",t)
            if product > största:
                största = product
